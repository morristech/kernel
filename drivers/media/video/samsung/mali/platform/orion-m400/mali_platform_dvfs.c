...
mali_dvfs_threshold_table mali_dvfs_threshold[MALI_DVFS_STEPS]={
    /*step 0*/{((int)((255*0)/100))   ,((int)((255*20)/100))},
    /*step 1*/{((int)((255*50)/100))  ,((int)((255*65)/100))},
    /*step 2*/{((int)((255*70)/100))  ,((int)((255*100)/100))} };
...
static unsigned int asv_3d_volt_5_table[ASV_5_LEVEL][MALI_DVFS_STEPS] = {
	...
	{850000, 900000, 950000},	/* S */
	{850000, 900000, 950000},	/* A */
	{ 850000,  900000, 950000},	/* B */
	{ 850000,  900000, 950000},	/* C */
	{ 850000,  900000,  900000},	/* D */
};

static unsigned int asv_3d_volt_8_table[ASV_8_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (100MHz) L2(160MHz), L1(267MHz) */
	{850000, 900000, 950000},	/* SS */
	{850000, 900000, 950000},	/* A1 */
	{850000, 900000, 950000},	/* A2 */
	{ 850000,  900000, 950000},	/* B1 */
	{ 850000,  900000, 950000},	/* B2 */
	{ 850000,  900000, 950000},	/* C1 */
	{ 850000,  900000, 950000},	/* C2 */
	{ 850000,  900000,  900000},	/* D1 */
};
#endif
